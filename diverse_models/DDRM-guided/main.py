...
def parse_args_and_config():
    ...
    # *** Meaning fulDiversity arguments
    parser.add_argument(
        '--path_y', type=str, required=True
    )
    parser.add_argument(
        '--parallel_batch', type=int, default=5
    )
    parser.add_argument(
        '--checkpoints_folder', type=str, default='../../checkpoints'
    )
    parser.add_argument(
        '--guidance_eta', type=float, default=0
    )
    parser.add_argument(
        '--guidance_dist', type=float, default=None
    )
    parser.add_argument(
        '--save_intermediate', action="store_true",
        help="Whether to save intermediate results of the process",
    )
...
def main():
    ...
    # logging.info("Writing log file to {}".format(args.exp))
